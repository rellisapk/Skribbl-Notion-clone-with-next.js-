...
export default function CompletedPage() {
    const [tasks, setTasks] = useState<TaskData[]>(
        dummyTasks.filter((t) => t.tag === 'Completed')
    );
    ...
    return (
        <div className="p-6 bg-white dark:bg-gray-900 min-h-screen text-gray-800 dark:text-white transition">
            <h2 className="text-2xl font-bold mb-6 text-gray-700 dark:text-gray-400">✅ Completed Tasks</h2>
            ...
            <div className="overflow-x-auto rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
                <table className="min-w-full text-sm text-left">
                    ...
                    <tbody>
                        {tasks.length === 0 ? (
                            <tr>
                                <td colSpan={4} className="px-4 py-6 text-center italic text-gray-400 dark:text-gray-500">
                                    No completed tasks 🎉
                                </td>
                            </tr>
                        ) : (
                ...
                {isDeleteModalOpen && taskToDelete && (
                    ...
                    >
                        <motion.div
                            ...
                            exit={{ scale: 0.9, y: 30 }}
                        >
                            <h3 className="text-lg font-semibold text-red-600 mb-3">Delete Task</h3>
                            <p className="mb-5">
